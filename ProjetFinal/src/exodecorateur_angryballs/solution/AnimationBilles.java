...
import exodecorateur_angryballs.solution.Ecouteurs.Ecouteur;
...
public class AnimationBilles extends Observable implements Runnable {
	...
	public void setVueBillard(VueBillard vueBillard) {
		this.vueBillard = vueBillard;
	}
	...
	public void run() {
		try {
			...
			double minRayons = AnimationBilles.minRayons(billes); // nécessaire
																	// au calcul
																	// de deltaT
			...
			{
				deltaT = COEFF * minRayons2 / (1 + maxVitessesCarrées(billes)); // mise
																				// à
																				// jour
																				// deltaT.
																				// L'addition
	...
	public void ajouterObserver(Ecouteur e) {
		this.addObserver(e);
		this.setChanged();
